			...
			<SheetContent side="right" className="flex flex-col p-0">
				...
				<SheetHeader className="justify-between border-b border-border px-6 py-4">
					<div className="flex items-center gap-3">
						...
						<span className="text-sm text-muted-foreground">({itemCount} Artikel)</span>
					</div>
					...
					<div className="bg-secondary/50 border-b border-border px-6 py-4">
						<div className="mb-2 flex items-center gap-2 text-sm">
							...
							{amountToFreeShipping > 0 ? (
								<span>
									Noch <strong>{formatMoney(amountToFreeShipping, currency)}</strong> bis zum kostenlosen Versand
								</span>
							) : (
								<span className="font-medium text-success">Du erhältst kostenlosen Versand!</span>
							)}
						</div>
				...
				<div className="flex-1 overflow-y-auto">
					{lines.length === 0 ? (
						<div className="flex h-full flex-col items-center justify-center px-6 text-center">
							...
							<h3 className="mb-2 text-lg font-medium">Dein Warenkorb ist leer</h3>
					...
					<div className="border-t border-border bg-background">
						...
						<div className="space-y-2 px-6 py-4">
							...
							<div className="flex items-center justify-between text-sm">
								...
								<span>{subtotal >= freeShippingThreshold ? "Kostenlos" : "Wird an der Kasse berechnet"}</span>
							</div>
						...
						<div className="flex items-center justify-center gap-6 border-t border-border px-6 pb-4 pt-4 text-xs text-muted-foreground">
							<span className="flex items-center gap-1.5">
								...
								Kostenloser Versand ab {formatMoney(freeShippingThreshold, currency)}
							</span>
							<span className="flex items-center gap-1.5">
