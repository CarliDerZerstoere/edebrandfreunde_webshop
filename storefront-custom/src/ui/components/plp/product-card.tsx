			...
			<Link href={product.href} className="block">
				...
				<div className="relative mb-4 aspect-[3/4] overflow-hidden rounded-xl bg-secondary">
					...
					<Image
						...
						className={cn(
							"object-cover transition-all duration-700 ease-out md:group-hover:scale-105",
				...
				<div className="space-y-1.5">
					...
					<h3 className="line-clamp-2 font-medium leading-snug transition-colors duration-300 md:group-hover:text-accent">
						{product.name}
					</h3>
