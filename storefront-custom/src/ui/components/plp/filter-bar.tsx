...
export function FilterBar({
	...
	return (
		<div className="sticky top-20 z-30 border-b border-border bg-background">
					...
					<div className="scrollbar-hide -mx-1 -my-1 flex items-center gap-2 overflow-x-auto px-1 py-1">
						...
						{priceRanges.length > 0 && onPriceRangeChange && (
							<DropdownMenu>
								...
								<DropdownMenuContent align="start" className="w-48">
									<DropdownMenuLabel>Preisbereich</DropdownMenuLabel>
									<DropdownMenuSeparator />
									<DropdownMenuRadioGroup
					...
					<div className="flex shrink-0 items-center gap-3">
						...
						<DropdownMenu>
							...
							<DropdownMenuContent align="end" className="w-48">
								...
								>
									<DropdownMenuRadioItem value="featured">Empfohlen</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="newest">Neueste</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="price_asc">Preis: Aufsteigend</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="price_desc">Preis: Absteigend</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="bestselling">Bestseller</DropdownMenuRadioItem>
								</DropdownMenuRadioGroup>
							</DropdownMenuContent>
						</DropdownMenu>
					</div>
					...
					<div className="scrollbar-hide -mx-1 mt-3 flex items-center gap-2 overflow-x-auto px-1 py-1">
						{activeFilters.map((filter) => (
							...
							>
								...
								>
									<X className="h-3 w-3" />
									<span className="sr-only">Filter {filter.value} entfernen</span>
								</button>
							</Badge>
						))}
						<Button
