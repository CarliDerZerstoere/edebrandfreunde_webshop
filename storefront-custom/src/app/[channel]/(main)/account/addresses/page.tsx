	...
	return (
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div>
					<h1 className="text-2xl font-semibold tracking-tight">Adressen</h1>
					<p className="mt-1 text-sm text-muted-foreground">Verwalten Sie Ihre gespeicherten Adressen</p>
				</div>
				<AddressFormDialog />
			</div>
